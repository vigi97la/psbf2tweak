#"Modern vehicle mainly pack from https://www.moddb.com/games/battlefield-2/addons, with some modified maps"
...
#should check for the existence of the necessary commands before trying to install things...
...
#AddNewVehicle $vehicleName $vehicleType $downloadLink $homePage $wiki $preCustomScript $postCustomScript
...
function AddNewVehicle($vehicleName, $vehicleType, $downloadLink, $homePage=$null, $wiki=$null, $preCustomScript=$null, $postCustomScript=$null) {
	$preCustomScript
