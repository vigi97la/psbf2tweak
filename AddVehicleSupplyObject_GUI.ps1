...
$form.width = 640
$form.height = 480
$form.Text = "AddVehicleSupplyObject"
...
"Add a mobile supply object on vehicles (see more info in ReadMe.txt, vehicles_db.csv and AddVehicleSupplyObject.ps1). "+
...
$applyButton.Add_Click({
	.\AddVehicleSupplyObject.ps1 $objectsFolderTextBox.Text $bUseVehiclesDBCheckbox.Checked $bIncludeStationaryWeaponsCheckbox.Checked $bIncludeAllCheckbox.Checked | Write-Host
})
